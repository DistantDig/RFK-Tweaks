...
public class RfkTweaks {
    ...
    public RfkTweaks(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = RfkTweaks.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
